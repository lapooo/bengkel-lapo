        ...
        <div class="app-content">
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form action="{{route('mekanik.store')}}" method="post" name="tambah">
                    <!--begin::Body-->
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                        <label class="form-label" for="">MEKANIK</label>
...
<!-- <form action="{{route('mekanik.store')}}" method="post" name="tambah">
    @csrf
    <label for="">Nama Jenis Mekanik : </label>
    <input type="text" name="mekanik" id="">
