        ...
        <div class="app-content">
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <!--begin::Form-->
                    @foreach($data as $row)
                    <form action="{{route('service.update',$id)}}" method="post" name="update">
                    <!--begin::Body-->
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                        <label class="form-label" for="">KELUHAN</label>
                        <input type="text" class="form-control" name="service" value="{{$row->keluhan}}" />
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        <label class="form-label" for="">TGL_MASUK</label>
                        <input type="text" class="form-control" name="service" value="{{$row->tgl_masuk}}" />
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        <label class="form-label" for="">TGL_KELUAR</label>
                        <input type="text" class="form-control" name="service" value="{{$row->tgl_keluar}}" />
                        </div>
                    </div>
                    <!--end::Body-->
                    <!--begin::Footer-->
